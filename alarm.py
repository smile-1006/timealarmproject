...
# Tkinter library is a standard python library for GUI 
from tkinter import * 
import time
import datetime
...
# creating a tkinter GUI and setting a window for python Alarm Clock.
root = Tk() 
...
def alarmclock(alarmtime): 
    ...
    # Getting current time by using .striftime() method of the datetime module's datetime file's now function
        ...
        if time_now==alarmtime:
            ...
            text="Wake up!Wake up!Wake up",fg="Red").grid(row=9,columnspan=4)
            print("wake up!")
            break
...
text="  SET A ALARM TO PROVE YOUR PUNCHUALITY  ").grid(row=7,columnspan=6)
